...
from visualiser_rules import VISUALISER_RULES
...
class AutomataGui(QMainWindow):
    ...
    def setup_gui(self):
        ...
        # --------------- registrace udalosti nad automatem--------------
    ...
    def model_changed(self, key):
        ...
        self.combo_visualisator.currentTextChanged.connect(self.visualiser_changed)
        ...
        self.create_adapter()
        self.visualiser_changed(self.combo_visualisator.currentText())

    def visualiser_changed(self, key):
        self.visualizer = VISUALISER_RULES[key]
        print(f"setVisualiser:{key}")
    ...
    def create_adapter(self):
        ...
        # adapter musi byt jiz vytvoren
        self.adapter_automata.state_updated.connect(self.update_canvas)
    ...
    #------------------- obsluha kresleni a dalsich udalosti ve automatu-----------------------
    def update_canvas(self, state_array):
        # state_array je 2D numpy array z automatu - to prevedu na bitmapu a budu kreslit
        print(f"Update canvas: {type(state_array)}")
        qimage = self.visualizer.visualize(state_array=state_array)
        self.canvas.set_buffer(qimage)
