...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        #self.iter_input.setValidator(QIntValidator(1, 10_000_000))
...
if __name__ == "__main__":
    ...
    app = QApplication(sys.argv)  # vytvor objekt aplikace, muze cist i prikazovou radku pomoci sys.argv
    window = MainWindow()  # vytvor hlavni okno aplikace
    window.show()
    sys.exit(app.exec())  # spust smycku zprav, komponenty si posilaji zpravy, okna se prekresluji

# TODO: Pokud Vás to nudí, tak program upravte tak, že je nejprve tlačítko zakázáno a povolí se když je počet iterací validní text.
# Připojte kontrolní metodu na událost tlačítka "textChanged"