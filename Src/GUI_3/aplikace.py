...
class AutomataGui(QMainWindow):
    ...
    def setup_gui(self):
        ...
        #--------------------- TODO sem by mely prijit udalosti tlacitek----------------
    ...
    def create_automata(self, key):
        # TODO Udelejte vytvoreni instance automatu dle vybraneho klice
        ...
        init_csv = "DOPNIT CTENI Z KONFIGU"
        init_class = RULES_DICT[self.config[key]["class"]]
        init_params = "DOPLNIT CTENI Z KOMPONENT"
        print(init_csv)
        print(init_class)
        print(init_params)
        # TODO nutno odkomentovat, aby to nepadalo, musi se vytvorit nejprve automat
